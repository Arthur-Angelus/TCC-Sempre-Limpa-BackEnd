...
router.get('/dados_veiculo', cors(), async function (request, response) {
...
router.get('/dados_veiculo/:id', cors(), async function (request, response) {
...
router.post('/dados_veiculo', cors(), bodyParserJSON, async function (request, response) {
...
router.put('/dados_veiculo/:id', cors(), bodyParserJSON, async function(request, response){
    let dados_veiculo_id = request.params.id
...
router.delete('/dados_veiculo/:id', cors(), async function(request, response){
    let dados_veiculo_id = request.params.id
